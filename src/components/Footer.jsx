        ...
        <footer className="footer">
                    ...
                    <div className="footer-grid">
                        ...
                        <div className="footer-brand">
                            <Link to="/" className="footer-logo">
                                ...
                                <span className="footer-logo-text"><span>IN</span>call</span>
                            </Link>
                            ...
                            <div className="footer-socials">
                                <a href="https://wa.me/919999999999" target="_blank" rel="noreferrer" className="social-icon" aria-label="WhatsApp">
                                ...
                                <a href="tel:+919999999999" className="social-icon" aria-label="Call">
                        ...
                        <div className="footer-section">
                            ...
                            <ul className="footer-contact-list">
                                ...
                                <li>
                                    ...
                                    <a href="mailto:support@incall.in">support@incall.in</a>
                                </li>
                                <li>
                                    <div className="contact-icon">🕐</div>
            ...
            <div className="footer-bottom">
                <div className="container footer-bottom-inner">
                    <p>© 2025 <span>INcall</span>. All rights reserved. Made with ❤️ in India.</p>
