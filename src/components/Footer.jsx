            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed mb-6 max-w-sm">
                            Your trusted partner for home services. Book professional technicians for AC repair, plumbing, electrical work, and more — all at your doorstep.
                        </p>
                        {/* Social Links */}
                        <div className="flex gap-3">
                            {[
                                ...
                                <a
                                    ...
                                    className={`w-10 h-10 rounded-xl glass border border-white/10 flex items-center justify-center text-slate-400 hover:text-white transition-all duration-300 ${social.color}`}
                                >
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-500 text-xs">Mon-Sun: 8AM - 10PM</p>
                                </div>
                            </li>
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-white text-sm font-medium">support@incall.com</p>
                            ...
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-500 text-xs">Serving all major cities</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <p className="text-slate-500 text-sm">
                        © {currentYear} <span className="text-indigo-400 font-semibold">Incall</span>. All rights reserved.
                    </p>
